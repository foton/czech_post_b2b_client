  ...
  module Test
    class GetParcelStateParserTest < Minitest::Test
      ...
      def test_it_parses_real_response_to_correct_structure
        parser = CzechPostB2bClient::ResponseParsers::GetParcelStateParser.call(xml: fixture_response_xml('getParcelState_ok_real.xml'))
        assert parser.success?, "Failed parser: #{parser.errors}"
      ...
      def test_it_handle_empty_parcels
        parser = CzechPostB2bClient::ResponseParsers::GetParcelStateParser.call(xml: fixture_response_xml('getParcelState_real_no_parcels.xml'))
        assert parser.success?, "Failed parser: #{parser.errors}"
      ...
      def expected_real_parcels_struct
        {
